...
import 'package:delivery/src/models/mercado_pago/mercado_pago_credit_cart.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_customer.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_issuer.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_payment_method.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_security_code.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_tax.dart';
import 'package:delivery/src/models/mercado_pago/mercado_pago_transaction_detail.dart';

class MercadoPagoPayment {
  String id = '';
  DateTime dateCreated = new DateTime.now();
  DateTime dateApproved = new DateTime.now();
  DateTime dateLastUpdated = new DateTime.now();
  DateTime dateOfExpiration = new DateTime.now();
  DateTime moneyReleaseDate = new DateTime.now();
  ...
  String collectorId = '';
  MercadoPagoCustomer payer = new MercadoPagoCustomer();
  ...
  int installments = 0;
  MercadoPagoCreditCard card = new MercadoPagoCreditCard(
    id: '',
    customerId: '',
    userId: '',
    expirationMonth: 0,
    ...
    securityCode: MercadoPagoSecurityCode(),
